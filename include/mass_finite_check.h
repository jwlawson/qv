 ...
 */
/**
 * Checks whether given matrices are mutation-finite. Initially the fast check
 * is used, and if necessary the whole mutation-class is computed. All matrices
 * in the class are then kept in a cache of mutation-finite quivers - so that
 * the class does not need to be repreatedly computed.
 */
#pragma once
